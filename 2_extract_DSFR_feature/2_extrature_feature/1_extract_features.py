...
roilist = []
#3D 数据
niipath = '/media/root/新加卷/xxt/bc/data_set/C6/all_0.8_0.8_0.8_small/'
...
# save path
savepath = '/media/root/新加卷/xxt/bc/reault/0.8_0.8_0.8_smallimg112_nor_unet/C6_0.001/ori/class_result/26/inner_feature_act10'
...
if __name__ == '__main__':
    ...
    weight_path = r'E:\workspace\BC\github/BC_model-' + modelnumnum + '.h5'
    #print(weight_path)

    # 加载模型To_xy_DSFR_features.py:114
    unet_seg_model = twoDNet_xxt((img_w, img_h, 1))

    # 定义提取模型
    extract_model = define_extract_model(unet_seg_model, weight_path=weight_path, extract_layer_name='activation_9')
    # print(unet_seg_model.summary())
